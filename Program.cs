...
namespace Demo_Filehandling_Streams
{
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            string filePath = @"C:\Users\Parth\source\repos\\Demo_Filehandling_Streams\bin\Debug\employees.json"; // Defining the file path where the JSON string will be written
